...
S3TEST_CONF=s3.conf ./virtualenv/bin/nosetests -v --with-xunit \
    ...
    s3tests.functional.test_headers:test_bucket_create_bad_expect_unreadable \
    ...
    s3tests.functional.test_headers:test_object_create_bad_amz_date_unreadable_aws4 \
    ...
    s3tests.functional.test_headers:test_bucket_create_bad_amz_date_unreadable_aws4 \
    ...
    s3tests.functional.test_s3:test_sse_kms_transfer_1b \
    s3tests.functional.test_s3:test_sse_kms_transfer_1kb \
    s3tests.functional.test_s3:test_sse_kms_transfer_1MB \
    ...
    s3tests.functional.test_s3:test_sse_kms_barb_transfer_1b \
