...
os.system('aws s3 ls >input.data')
os.system("awk '{print $3}' input.data")
os.system('cat input.data')

client = boto3.client('s3')
Bucket = 's3-l42e7tw6s2r3zjd1v1rwokd1t5-351'
Prefix = '' # leave blank to delete the entire contents
IsTruncated = True
MaxKeys = 1000
KeyMarker = None
