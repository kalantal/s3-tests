...
tests() {
	...
	s3tests.functional.test_headers:test_bucket_create_bad_contentlength_none \
	...
	s3tests.functional.test_headers:test_object_create_bad_amz_date_empty_aws4 \
	...
	s3tests.functional.test_headers:test_object_create_bad_amz_date_before_today_aws4 \
	s3tests.functional.test_headers:test_object_create_bad_date_after_today_aws4 \
	s3tests.functional.test_headers:test_object_create_bad_amz_date_after_today_aws4 \
	...
	s3tests.functional.test_headers:test_object_create_bad_amz_date_after_end_aws4 \
	...
	s3tests.functional.test_headers:test_bucket_create_bad_date_invalid_aws4 \
	s3tests.functional.test_headers:test_bucket_create_bad_amz_date_invalid_aws4 \
	s3tests.functional.test_headers:test_bucket_create_bad_date_empty_aws4 \
	s3tests.functional.test_headers:test_bucket_create_bad_amz_date_empty_aws4 \
	...
	s3tests.functional.test_s3:test_lifecycle_transition \
	s3tests.functional.test_s3:test_lifecycle_transition_single_rule_multi_trans \
	s3tests.functional.test_s3:test_lifecycle_set_noncurrent_transition \
	s3tests.functional.test_s3:test_lifecycle_noncur_transition \
	s3tests.functional.test_s3:test_object_storage_class \
	s3tests.functional.test_s3:test_object_storage_class_multipart \
	s3tests.functional.test_s3:test_object_modify_storage_class \
	s3tests.functional.test_s3:test_object_modify_storage_class_multipart \
	s3tests.functional.test_s3:test_object_storage_class_copy \
	s3tests.functional.test_s3:test_object_storage_class_copy_multipart \
	...
	s3tests_boto3.functional.test_headers:test_object_create_bad_md5_invalid_short \
	s3tests_boto3.functional.test_headers:test_object_create_bad_md5_bad \
	s3tests_boto3.functional.test_headers:test_object_create_bad_md5_empty \
	s3tests_boto3.functional.test_headers:test_object_create_bad_md5_none \
	...
	s3tests_boto3.functional.test_headers:test_object_create_bad_contentlength_negative \
	...
	s3tests_boto3.functional.test_headers:test_object_create_bad_contenttype_empty \
	s3tests_boto3.functional.test_headers:test_object_create_bad_contenttype_none \
	...
	s3tests_boto3.functional.test_headers:test_bucket_create_contentlength_none \
	...
	s3tests_boto3.functional.test_headers:test_bucket_create_bad_expect_empty \
	s3tests_boto3.functional.test_headers:test_bucket_create_bad_contentlength_empty \
	s3tests_boto3.functional.test_headers:test_bucket_create_bad_contentlength_negative \
	...
	s3tests_boto3.functional.test_headers:test_object_create_bad_md5_invalid_garbage_aws2 \
	...
	s3tests_boto3.functional.test_headers:test_object_create_bad_date_before_today_aws2 \
	s3tests_boto3.functional.test_headers:test_object_create_bad_date_before_epoch_aws2 \
	s3tests_boto3.functional.test_headers:test_object_create_bad_date_after_end_aws2 \
	s3tests_boto3.functional.test_headers:test_bucket_create_bad_authorization_invalid_aws2 \
	s3tests_boto3.functional.test_headers:test_bucket_create_bad_ua_empty_aws2 \
	s3tests_boto3.functional.test_headers:test_bucket_create_bad_ua_none_aws2 \
	...
	s3tests_boto3.functional.test_headers:test_bucket_create_bad_date_before_today_aws2 \
	s3tests_boto3.functional.test_headers:test_bucket_create_bad_date_after_today_aws2 \
	...
	s3tests_boto3.functional.test_s3:test_object_read_notexist \
	...
	s3tests_boto3.functional.test_s3:test_versioning_multi_object_delete_with_marker_create \
	...
	s3tests_boto3.functional.test_s3:test_sse_kms_barb_transfer_1b \
	s3tests_boto3.functional.test_s3:test_sse_kms_barb_transfer_1kb \
	s3tests_boto3.functional.test_s3:test_sse_kms_barb_transfer_1MB \
	s3tests_boto3.functional.test_s3:test_sse_kms_barb_transfer_13b \
	...
	s3tests_boto3.functional.test_utils.test_generate \
	s3tests_boto3.fuzz.test.test_fuzzer:test_load_graph \
	s3tests_boto3.fuzz.test.test_fuzzer:test_descend_leaf_node \
	s3tests_boto3.fuzz.test.test_fuzzer:test_descend_node \
	s3tests_boto3.fuzz.test.test_fuzzer:test_descend_bad_node \
	s3tests_boto3.fuzz.test.test_fuzzer:test_descend_nonexistant_child \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_random_printable \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_random_binary \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_random_printable_no_whitespace \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_random_binary_no_whitespace \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_random_no_args \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_random_no_charset \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_random_exact_length \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_random_bad_charset \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_random_missing_length \
	s3tests_boto3.fuzz.test.test_fuzzer:test_assemble_decision \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_escape \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_indirect \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_indirect_double \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_recursive \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_recursive_mutual \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_recursive_not_too_eager \
	s3tests_boto3.fuzz.test.test_fuzzer:test_make_choice_unweighted_with_space \
	s3tests_boto3.fuzz.test.test_fuzzer:test_weighted_choices \
	s3tests_boto3.fuzz.test.test_fuzzer:test_null_choices \
	s3tests_boto3.fuzz.test.test_fuzzer:test_weighted_null_choices \
	s3tests_boto3.fuzz.test.test_fuzzer:test_null_child \
	s3tests_boto3.fuzz.test.test_fuzzer:test_weighted_set \
	s3tests_boto3.fuzz.test.test_fuzzer:test_header_presence \
	s3tests_boto3.fuzz.test.test_fuzzer:test_duplicate_header \
	s3tests_boto3.fuzz.test.test_fuzzer:test_expand_headers \
	test_realistic.TestFileValidator:test_new_file_is_valid \
	test_realistic.TestFileValidator:test_new_file_is_valid_on_several_calls \
	test_realistic.TestFileValidator:test_new_file_is_valid_when_size_is_1 \
	test_realistic.TestFiles:test_random_file_valid
...
results() {
mkdir -p ./output
cp nosetests.xml ./output/"$(date -d "today" +"s3-test-results-%Y-%m-%d-%H-%M").xml"
cp nosetests.csv ./output/"$(date -d "today" +"s3-test-results-%Y-%m-%d-%H-%M").csv"
rm nosetests.csv -f
rm nosetests.xml -f
}
results
